<template>
	<div>
		<div class="act07">
				...
				<div class="charge">
					<div class="chargeCon">
						<div class="number fs-12 col-70">
							<div style="margin-bottom: 0.08rem;"><span style="width: 22%;">参会人数</span><span style="width: 15%;font-weight: 600;">{{ info.numberOfParticipants }}人</span><span
								 style="width: 35%;text-align: right;">{{ info.discountMsg }}</span><span style="width: 28%;text-align: right;font-weight: 600;">&yen;
									{{ info.priceOfParticipants }}</span></div>
							<div style="margin-bottom: 0.08rem;"><span style="width: 22%;">考察人数</span><span style="width: 15%;font-weight: 600;">{{ info.numberOfSelfSelection }}人</span><span
								 style="width: 35%;text-align: right;">{{ info.discountMsg }}</span><span style="width: 28%;text-align: right;font-weight: 600;">&yen;
									{{ info.priceOfSelfSelection }}</span></div>
						</div>
						<div class="total pd-16">
							<span class="fs-12 col-70" style="width: 20%;">总计</span><span style="width: 80%;text-align: right;color: #e5004f;font-size: 0.16rem;font-weight: 600;">&yen;{{ info.totalPrice }}</span>
						</div>
			...
			<div class="lay" style="width: 100%;" v-show="shareLay"><img src="../../../../static/img/act/20180818/18layer.png"
				 alt="" style="width: 100%;height: 100%;" @click="closeLay()" /></div>
		</div>
	</div>
</template>
<script>
...
<style scoped>
	...
	.act07 .chargeCon .number,
	.act07 .chargeCon .total,
	.act07 .chargeCon .account_code {
