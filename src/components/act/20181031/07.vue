			...
			<div class="charge">
				...
				<div class="chargeCon">
					<div class="info col70 fs-24" style="background-color: #f4f7fa;">
						<div class="number">
							<div style="margin-bottom: 0.08rem;" class="clearfix"><span style="width: 25%;" class="fl">联系姓名</span><span
								 style="font-weight: 600;">{{ info.contactPerson }}</span></div>
							<div style="margin-bottom: 0.08rem;" class="clearfix"><span style="width: 25%;" class="fl">联系手机</span><span
								 style="font-weight: 600;">{{ info.mobile }}</span></div>
							<div style="margin-bottom: 0.08rem;" class="clearfix"><span style="width: 25%;" class="fl">预订别墅</span><span
								 style="font-weight: 600;">{{ info.numberOfSelfSelection }}栋</span></div>
							<div style="margin-bottom: 0.08rem;" class="clearfix"><span style="width: 25%;" class="fl">住宿时间</span><span
								 style="font-weight: 600;">{{ info.period }}</span></div>
						</div>
						<div style="padding: 0.1rem 0;">
							<div style="margin-bottom: 0.08rem;" class="clearfix"><span style="width: 25%;" class="fl">优惠</span><span style="text-align: right;font-weight: 600;color: red;"
								 class="fr">{{ info.discountMsg }}</span></div>
							<div style="margin-bottom: 0.08rem;" class="clearfix"><span style="width: 25%;" class="fl">参考总价</span><span
								 style="text-align: right;font-weight: 600;" class="fr">&yen;{{ info.totalPrice }}</span></div>
							<div style="margin-bottom: 0.08rem;" class="clearfix"><span style="width: 25%;" class="fl">折扣价</span><span style="text-align: right;font-weight: 600;color: red;"
								 class="fr">&yen;{{ info.discountPrice }}</span></div>
						</div>
					</div>
					<div style="padding: 0 0.08rem 0.15rem 0.08rem;">
						...
						<div class="account_code pd-16">
							<span class="fs-24 col70" style="width: 16%;">对账码</span><span style="width: 67%;font-weight: 600;font-size: 0.15rem;">{{ info.checkAccountCode }}</span><img
...
<style scoped>
	...
	.act_stay07 .chargeCon .number,
	.act_stay07 .chargeCon .total,
	.act_stay07 .chargeCon .account_code {
