		...
		<div class="act05">
			<div class="share">
				<div class="share_con">
					...
					<div class="int">
						三亚·亚太金融小镇作为海南的第一个金融小镇，第一期2.8万平方米已经建成，地处国家海岸海棠湾，享有三亚税收返还政策优惠，与301医院及人大附中近在咫尺。小镇以海上丝绸之路总部基地，亚太金融资本合作平台为宗旨，致力于打造产学研三位一体的金融平台。</div>
			...
			<div class="lay" style="width: 100%;" v-show="shareLay"><img src="../../../../static/img/act/shareLay.png" alt=""
				 style="width: 100%;height: 100%;" @click="closeLay()" /></div>
		</div>
	</div>
</template>
<script>
