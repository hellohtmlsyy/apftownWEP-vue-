<template>
	<div class="ticketsCode ee2019">
		<div class="con">
			...
			<div class="code">
				<div class="mb-15 col-fff lh-24"><span class="fs-18 fw-7">{{type == 3? '赞助商' : '会议'}}入场二维码</span><br /><span class="fs-12">限定{{type == 4? '媒体' : '本人'}}使用</span></div>
...
<script>
	...
	export default {
		...
		methods: {
			qrcode() { // 生成二维码
				let text = this.$root.urlPath.M_APF + '/ee2019/home';
